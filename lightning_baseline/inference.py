...
def main(cfg: DictConfig):
    ...
    filename_and_class = []
    with torch.no_grad():
        for _, (images, image_names) in tqdm(enumerate(data_loader), total=len(data_loader)): 
