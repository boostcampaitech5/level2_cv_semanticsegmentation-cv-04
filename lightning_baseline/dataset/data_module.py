...
class XRayDataset(Dataset):
    def __init__(self, is_train=True, transforms=None):
        ...
        # split train-valid
        # 한 폴더 안에 한 인물의 양손에 대한 `.dcm` 파일이 존재 => 폴더 이름을 그룹으로 해서 GroupKFold를 수행
...
class DataModule(L.LightningDataModule):
    ...
    def train_dataloader(self):
        return DataLoader(
            XRayDataset(is_train=True, transforms=self.transforms),
...
if __name__ == "__main__":
    ...
    data = DataModule()
    for image, label in data.train_dataloader():
